...
export default function Home() {
  return (
    <div>
      ...
      <div className="w-full h-screen bg-neutral-900 flex flex-row px-2 py-2 justify-around  ">
        <div className="w-80 h-80 relative rounded-xl drop-shadow-2xl mt-12 items-center align-middle ">
          <Image
            src="/gzzz.jpeg"
            alt="GZZZ"
            fill
